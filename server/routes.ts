...
// AegisAI360 Endpoint Agent v${AGENT_VERSION}
// Generated by AegisAI360 | FAHADERA LLC
...
async function main() {
  console.log(\`AegisAI360 Endpoint Agent v\${AGENT_VERSION} starting...\`);
  console.log(\`[AegisAI360] Host: \${os.hostname()} | Server: \${SERVER_URL}\`);
...
echo "━━━ AegisAI360 Endpoint Agent v$VERSION Installer ━━━"
...
`;
    ...
    if (pkgType === "sh") {
      return `#!/usr/bin/env bash
# AegisAI360 Endpoint Agent v${AGENT_VERSION} — Universal Linux Installer
...
${commonBody}`;
    ...
    if (pkgType === "deb") {
      ...
      const debHeader = [
        "#!/usr/bin/env bash",
        `# AegisAI360 Endpoint Agent v${AGENT_VERSION} — Debian/Ubuntu Installer`,
    ...
    const rpmHeader = [
      "#!/usr/bin/env bash",
      `# AegisAI360 Endpoint Agent v${AGENT_VERSION} — CentOS/RHEL Installer`,
